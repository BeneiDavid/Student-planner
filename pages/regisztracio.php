...
<?php
    ...
    <form method="post" class='content-padding'>
        ...
        <input type="text" id="username" name="username" class="form-control input-length" autocomplete="username" value="<?php echo isset($username) ? htmlspecialchars($username) : ''; ?>"><br>
