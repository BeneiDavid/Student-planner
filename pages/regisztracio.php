...
<?php
    ...
    if (isset($_POST['reg_button']))
    {
        ...
        if($validator->validateForm()){
            echo '<div class="content-padding"><div class="alert alert-success succesful-registration-alert" role="alert">Sikeres regisztráció! <br> Kérem erősítse meg e-mail címét a postafiókjára érkező link segítségével! <br> Előfordulhat, hogy az e-mail a spam mappába kerül, vagy nem érkezik meg azonnal.</div></div><br>';
        }
        else{
    ...
    <form method="post" class='content-padding'>
        ...
        <input type="text" id="fullname" name="fullname" class="form-control input-length" value="<?php echo isset($fullname) ? htmlspecialchars($fullname) : ''; ?>"><br>
        ...
        <input type="text" id="username"  maxlength="6" name="username" class="form-control input-length" autocomplete="username" value="<?php echo isset($username) ? htmlspecialchars($username) : ''; ?>"><br>
        ...
        <input type="email" id="email" name="email" class="form-control input-length" autocomplete="email" value="<?php echo isset($email) ? htmlspecialchars($email) : ''; ?>"><br>
