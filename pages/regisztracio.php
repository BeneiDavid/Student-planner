...
<?php
    ...
    <form method="post" class='content-padding'>
        ...
        <input type="text" id="username" name="username" class="form-control input-length" value="<?php echo $username; ?>"><br>
        ...
        <input type="email" id="email" name="email" class="form-control input-length" value="<?php echo $email; ?>"><br>
